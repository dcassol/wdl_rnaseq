...
requirements:
  InitialWorkDirRequirement:
    listing: [ $(inputs.nameAndPathOfAnalysisFolder) ]
...
inputs:
  ...
  SampleName:
    ...
    type: string
  nameAndPathOfAnalysisFolder:
    label: "Path to the analysis directory"
    type: Directory
  results_path:
    label: "Path to the results directory"
    type: Directory

stdout: $(inputs.nameAndPathOfAnalysisFolder.path)/$(inputs.results_path.path)/$(inputs.SampleName).sam
