...
```{r setup2, echo=FALSE, messages=FALSE, warnings=FALSE}
...
```{r create_sal, message=FALSE, eval=TRUE}
sal <- SPRproject()
sal <- importWF(sal, "../SPR/systemPipeRNAseq.Rmd")
```
...
```{r create_sal2, message=FALSE, eval=FALSE}
sal <- SPRproject()
```
